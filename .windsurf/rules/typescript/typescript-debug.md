...
- For the full checklist (file size, one per file, types in `types/`, etc.) and common issues/fixes, see [code-quality-guidelines.mdc](.windsurf/rules/core/code-quality-guidelines.mdc).