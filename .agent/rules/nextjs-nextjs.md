...
- Server Actions: `.agent/rules/nextjs/server-actions.mdc`
- Forms/Actions: `.agent/rules/nextjs/forms-and-actions.mdc`
- Data Fetching: `.agent/rules/nextjs/data-fetching.mdc`
- Rendering/Performance: `.agent/rules/nextjs/rendering-performance.mdc`
- Error/Observability: `.agent/rules/nextjs/error-observability.mdc`
